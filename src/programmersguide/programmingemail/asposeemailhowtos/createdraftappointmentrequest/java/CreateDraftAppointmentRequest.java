...
package programmersguide.programmingemail.asposeemailhowtos.createdraftappointmentrequest.java;
...
public class CreateDraftAppointmentRequest
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir = "src/programmersguide/programmingemail/asposeemailhowtos/createdraftappointmentrequest/data/";
