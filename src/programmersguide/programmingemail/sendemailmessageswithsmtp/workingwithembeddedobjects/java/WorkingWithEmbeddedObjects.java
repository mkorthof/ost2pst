...
package programmersguide.programmingemail.sendemailmessageswithsmtp.workingwithembeddedobjects.java;
...
public class WorkingWithEmbeddedObjects
{
    public static void main(String[] args) throws Exception
    {
        ...
        String dataDir = "src/programmersguide/programmingemail/sendemailmessageswithsmtp/workingwithembeddedobjects/data/";
