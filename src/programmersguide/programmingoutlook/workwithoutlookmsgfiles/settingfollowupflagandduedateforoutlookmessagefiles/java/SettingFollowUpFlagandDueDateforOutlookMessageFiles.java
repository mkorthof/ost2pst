...
package programmersguide.programmingoutlook.workwithoutlookmsgfiles.settingfollowupflagandduedateforoutlookmessagefiles.java;
...
public class SettingFollowUpFlagandDueDateforOutlookMessageFiles
{
    public static void main(String[] args) throws Exception
    {
        // The path to the documents directory.
        String dataDir = "src/programmersguide/programmingoutlook/workwithoutlookmsgfiles/settingfollowupflagandduedateforoutlookmessagefiles/data/";
