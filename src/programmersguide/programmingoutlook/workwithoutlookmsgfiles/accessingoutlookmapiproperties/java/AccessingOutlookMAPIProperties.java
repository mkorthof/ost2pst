...
public class AccessingOutlookMAPIProperties
{
    public static void main(String[] args) throws Exception
    {
        ...
        try
        {
          ...
          MapiProperty prop = (MapiProperty)coll.get((Object)MapiPropertyTag.PR_SUBJECT);

          //if the MapiProperty is not found, check the MapiProperty.PR_SUBJECT_W
          //which is a unicode peer of MapiPropertyTag.PR_SUBJECT
          if (prop == null)
          {
            prop = (MapiProperty)coll.get(MapiPropertyTag.PR_SUBJECT_W);
          }
           ...
           else
           {
             ...
             prop = (MapiProperty)coll.get(MapiPropertyTag.PR_INTERNET_CPID);
             if (prop != null)
             {
